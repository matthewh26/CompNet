...
def get_winrates(data,role_player,role_other,team_other,champ_player):
    ...
    total_matches = data[data[other_col]==champ_player]

    for champ in set(total_matches[player_col]):
